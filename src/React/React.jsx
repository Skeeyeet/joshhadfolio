            ...
            <div className="row">
                ...
                <div className="col-12 col-xl-8 col-lg-10 ">
                    <Carousel>
                        ...
                        <Carousel.Item>
                            <ImageCarosueselContent Src="ContactUsCode.png" Content="These are the some of the components I made for the contact us page. Everything uses an id to get text content" Alt="Contact us" />
                        </Carousel.Item>
                    </Carousel>
                </div>
                <div className="col" />
